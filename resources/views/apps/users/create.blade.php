...
<div class="container-fluid">
    ...
    <div class="info-box">
        ...
        <span class="text-muted">
            Isi semua data pengguna dengan lengkap. Password minimal 8 karakter dan harus diisi.
            Pengguna akan menerima email konfirmasi setelah didaftarkan.
        </span>
    </div>
            ...
            <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <div class="form-text">
                            <i class="fas fa-info-circle"></i>
                            Upload foto profil (opsional). Format: JPG, PNG, GIF. Maks: 2MB
                        </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="form-text">
                            <i class="fas fa-info-circle"></i>
                            Password minimal 8 karakter dan harus diisi
                        </div>
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-select @error('job_division_id') is-invalid @enderror"
                            ...
                            <option value="{{ $division->id }}" {{ old('job_division_id') == $division->id ? 'selected' : '' }}>
                                {{ $division->name }}
                            </option>
                            @endforeach
                        </select>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        passwordInput.addEventListener('input', function() {
            ...
            strengthText.textContent = value.length > 0 ? messages[strength] : 'Ketik password untuk melihat kekuatan';
